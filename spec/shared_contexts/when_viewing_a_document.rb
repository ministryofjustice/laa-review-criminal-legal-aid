      ...
      .with(
        body: {
          ...
          s3_opts: {
            ...
            response_content_disposition: "inline; filename=#{filename}; filename*= UTF-8''#{filename};"
          }
        }
      )
