module Casework
  class CrimeApplicationsController < Casework::BaseController
    ...
    def open
      set_search(
        default_filter: { application_status: 'open', work_stream: [current_work_stream.to_s] },
    ...
    def closed
      set_search(
        default_filter: { application_status: 'closed', work_stream: [current_work_stream.to_s] },
