...
as: :latest_complete_temporal_report
    ...
    get ':report_type/:interval/latest-complete/caseworker/:user_id',
        to: 'caseworker_temporal_reports#latest_complete', as: :latest_complete_caseworker_temporal_report
    get ':report_type/:interval/:period/caseworker/:user_id',
        to: 'caseworker_temporal_reports#show', as: :caseworker_temporal_report
